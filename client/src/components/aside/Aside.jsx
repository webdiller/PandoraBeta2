...
export default function Aside() {
    return (
        <nav className="aside">
            <NavLink className="aside__item" activeClassName="aside__item_active" exact to="/dashboard">Личный кабинет</NavLink>
            ...
            <NavLink className="aside__item" activeClassName="aside__item_active" exact to="/settings-profile">Настройки</NavLink>
            ...
            <NavLink className="aside__item aside__item_icon" activeClassName="aside__item_active" exact to="/settings-profile"><i className="fas fa-user-cog"></i></NavLink>
